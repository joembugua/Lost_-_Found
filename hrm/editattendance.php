...
<div class="container">
  ...
  <form action="" method="POST">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="AttendanceName" value="<?php echo $AttendanceName;?>" name="AttendanceName" readonly>
    </div>
    <div class="form-group">
      <label for="Available">Available Packagers:</label>
      <input type="number" class="form-control" id="Available" value="<?php echo $Available;?>" name="Available" readonly>
    </div>
    <div class="form-group">
      <label for="WagePerPackager">Wage Per Packager</label>
      <input type="number" class="form-control" id="WagePerPackager" value="<?php echo $WagePerPackager;?>" name="WagePerPackager" readonly>
    </div>
    <div class="form-group">
      <label for="Bales">Bales:</label>
      <input type="number" class="form-control" id="Bales" value="<?php echo $Bales;?>" name="Bales" readonly>
    </div>
    <div class="form-group">
      <label for="2KGBales">2KGBales:</label>
      <input type="number" class="form-control" id="2KGBales" value="<?php echo $_2KGBales;?>" name="2KGBales" readonly>
    </div>
    <div class="form-group">
      <label for="1KGBales">1KGBales:</label>
      <input type="number" class="form-control" id="1KGBales" value="<?php echo $_1KGBales;?>" name="1KGBales" readonly>
    </div>
    <div class="form-group">
